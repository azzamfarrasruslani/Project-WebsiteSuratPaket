...
module.exports = {
  content: [
    ...
    './public/js/**/*.js', // Jika Anda memiliki file JavaScript di folder public
    './app/Controllers/**/*.php', // Jika Anda ingin memindai controller juga
    './app/Models/**/*.php', // Jika Anda ingin memindai model juga
  ],
  darkMode: "class",
  theme: {
    screens: {
