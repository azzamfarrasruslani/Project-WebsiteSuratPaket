                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    ...
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input
                                            ...
                                            value="<?= $serah_terima['waktu_penyerahan'] ?>" required>
                                    </div>
                                ...
                                <div class="flex flex-wrap -mx-3 mb-12">
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <div class="relative">
                                            <select
                                                class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="ekspedisi" name="ekspedisi" onchange="handleOtherOption(this)">
                                        ...
                                        <input
                                            class="other-input hidden appearance-none mb-6  w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-2 leading-tight focus:outline-none focus:bg-white"
                                            id="otherInput" name="otherInput" type="text"
                                        ...
                                        <script>
                                            function handleOtherOption(select) {
                                                ...
                                                if (select.value === 'other') {
                                                    ...
                                                    otherInput.value = ''; // clear input value if hidden
                                                }
                                            }
                                        </script> -->
                                    </div>
