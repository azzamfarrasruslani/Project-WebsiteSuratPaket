...
<div class="w-full px-6 py-6 mx-auto">
  ...
  <div class="flex flex-wrap mt-6 -mx-30">
    ...
    <?php foreach ($dataRiwayat as $index => $item): ?>
        <ul class="flex flex-col pl-0 mb-0 rounded-lg">
            <?php if ($item['activity'] == 'User logged out'): ?>
                <li class="relative flex flex-wrap lg:flex-nowrap whitespace-nowrap justify-between px-4 py-2 pl-0 mb-2 border-0 rounded-t-inherit text-inherit rounded-xl">
                    <div class="flex items-center w-full sm:w-auto">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs leading-tight dark:text-white/80"><?= date('d F Y, \a\t h:i A', strtotime($item['activity_time'])) ?></span>
                        </div>
                    </div>
                    <div class="flex flex-col items-center justify-center sm:mt-0 mt-2">
                        <p class="relative z-10 inline-block m-0 text-xs font-semibold leading-normal text-transparent bg-gradient-to-tl from-red-600 to-orange-600 bg-clip-text sm:mt-0 mt-2">
                            <?= $_SESSION['nama_security'] ?> Melakukan logout
                        </p>
                    </div>
                </li>
            <?php elseif ($item['activity'] == 'User logged in'): ?>
                <li class="relative flex flex-wrap lg:flex-nowrap whitespace-nowrap justify-between px-4 py-2 pl-0 mb-2 border-0 border-t-0 rounded-b-inherit text-inherit rounded-xl">
                    <div class="flex items-center w-full sm:w-auto">
                    ...
                    <div class="flex flex-col items-center justify-center sm:mt-0 mt-2">
                        <p class="relative z-10 inline-block m-0 text-xs font-semibold leading-normal text-transparent bg-gradient-to-tl from-green-600 to-lime-400 bg-clip-text">
